...
public class Constantes {
   ...
   */
    ...
    public static final byte COND_EQ        = 1;
    public static final byte COND_NE        = 2;
    public static final byte COND_LT        = 3;
    public static final byte COND_LE        = 4;
    public static final byte COND_GT        = 5;
    public static final byte COND_GE        = 6;
